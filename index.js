/*
ainda é preciso limitar a quantidade de caracteres 
em parte inteira do número introduzido. Depois de 16 
caracteres pode dar erro (os caracteres seguintes apresentam-se como 0).
*/

/* 
o calculador tem a seguinte lógica:
as botóes "+ - / *" desempenham a função "=" em alguns casos:
quando chamados logo depois de um deles sem indtroduzir algum número.
Exemplo: 
6-+ => 6+ (ou seja: 6-0=6 => 6+)
6*+ => 0+ (ou seja: 6*0=0 => 0+)
